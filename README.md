...
This paper proposes a fusing multiple code features (FMCF) approach based on Transformer for Solidity smart Contracts. This approach can extract and fuse the SBT sequence features and AST features , improving the quality of contract code summarization.This approach expands the research methods in this field and aims to effectively solve the key problems of code semantic and structural information loss in traditional methods. FMCF comprehensively utilizes the technical strengths of the Graph Attention Network (GAT) encoder and CodeBERT encoder to achieve a more in-depth and comprehensive code understanding. By combining the self-attention mechanism with advanced feature extraction and feature fusion technology, FMCF can more accurately identify and align data features, thereby significantly improving the accuracy and efficiency of data processing.
## Datasets and Model
